...
contract RollupNC is Update_verifier, Withdraw_verifier{
    ...
    /// @Dev executed by coordinator to verify SNARK proof that account merkle root 
    /// is updated correcly by transactions.
    ...
    function withdraw(
        uint[9] memory txInfo, //[fromX, fromY, index, toX ,toY, nonce, amount, token_type, txRoot]
