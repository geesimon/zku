...
/// @dev test HarmonyProver smart contract
describe('HarmonyProver', function () {
    /// @dev deploy MMRVerifier and HarmonyProver smart contract
    ...
    /// @dev test prover can parse checkpoint block data
    ...
    /// @dev test prover can retreive receipt proof from transactions
...
describe('TokenLocker', function () {
    /// @dev deploy TokenLockerOnEthereum smart contract
    beforeEach(async function () {
    ...
    /// @todo: check unlock eth after verifying proof of burning Harmony token
